...
public class UserDialogForAdvertisement extends AppCompatDialogFragment {
        ...
        builder.setView(view)
                ...
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        listener.getAuthenticateForAdvertisement(userMail, idul);
                    }
                });
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (UserDialogForAdvertisement.DialogFragmentListener) context;
    ...
    public interface DialogFragmentListener {
        void getAuthenticateForAdvertisement(String userMail, int idul);
    }
}